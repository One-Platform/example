...
</a><a class="guide--title" href="http://spring.io/guides/gs/rest-service/">Building a RESTful Web Service</a>
    <p class="guide--subtitle">Learn how to create a RESTful web service with Spring.</p>
</div>
<div class="guide--container" data-filterable="Scheduling Tasks Learn how to schedule tasks with Spring. [scheduling]">
    <a class="guide--title" href="http://spring.io/guides/gs/scheduling-tasks/">Scheduling Tasks</a>
    <p class="guide--subtitle">Learn how to schedule tasks with Spring.</p>
</div>
<div class="guide--container" data-filterable="Detecting a Device Learn how to use Spring to detect the type of device that is accessing your web site. []">
    <a class="guide--title" href="http://spring.io/guides/gs/device-detection/">Detecting a Device</a>
    <p class="guide--subtitle">Learn how to use Spring to detect the type of device that is accessing your web site.</p>
</div>
</div>
</div>
<div class="content-container--body">
    <div data-filterable-container="">
        ...
        <div class="guide--container" data-filterable="Designing and Implementing RESTful Web Services with Spring Learn how to design and implement RESTful web services with Spring">
            <a class="guide--title" href="http://spring.io/guides/tutorials/rest/">Designing and Implementing RESTful Web Services with Spring</a>
            <p class="guide--subtitle">Learn how to design and implement RESTful web services with Spring</p>
        </div>
        <div class="guide--container" data-filterable="Data Access with Spring Learn how to use multiple data stores to persist and retrieve data with Spring">
            <a class="guide--title" href="http://spring.io/guides/tutorials/data/">Data Access with Spring</a>
            <p class="guide--subtitle">Learn how to use multiple data stores to persist and retrieve data with Spring</p>
        </div>
        <div class="guide--container" data-filterable="Designing and Implementing a Web Application with Spring Learn how to design and implement a web app with Spring">
            <a class="guide--title" href="http://spring.io/guides/tutorials/web/">Designing and Implementing a Web Application with Spring</a>
            <p class="guide--subtitle">Learn how to design and implement a web app with Spring</p>
        </div>
    </div>
</div>
</div>
