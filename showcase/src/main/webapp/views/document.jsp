...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/js/document.js"></script>
</head>
<body>
...
<div class="container">
    ...
    <div class="item-dropdown-widget docs--item js-item-dropdown--wrapper"  id="web">
        ...
        <div class="item--dropdown docs-version--dropdown">
            <div class="item--header">
                <a class="item--header-link item--left-column" href="${ctx}/project/web">
                    <i class="icon-globe"></i>
                    Site
                </a>
                <a class="item--header-link item--right-column" href="https://github.com/One-Platform/example">
                    <i class="icon-github"></i>
                    Repo
                </a>
            </div>
                ...
                <div class="item--body">
                    ...
                    <div>
                        <div class="item--body--version">
                            ...
                            <div class="item--right-column">
                                <a class="docs-link reference-link" href="${ctx}/project/doc">Reference</a>
                                <a class="docs-link api-link" href="${ctx}/api/apidocs-web/index.html">API</a>
                            </div>
                        </div>
                    </div>
