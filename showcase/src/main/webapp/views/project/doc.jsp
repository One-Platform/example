...
<link href="${ctx}/static/css/bootstrap/bootstrap_master.css"
	rel="stylesheet" />
<!-- Favicons -->
			...
			<div class="col-md-3">
				<div class="bs-sidebar hidden-print affix" role="complementary">
					<ul class="nav bs-sidenav">
						<li><a href="#introduction">1.Web MVC Framework</a>
							<ul class="nav">
								<li><a href="#modifyWeb">1.1 版本历史 </a></li>
								<li><a href="#addCryptoConfig">1.2
										Web-Platform基本原理和特性介绍</a></li>
								<li><a href="#modifyWeb">1.3 如何构建一个Restful风格的web项目 </a></li>
								<li><a href="#addCryptoConfig">1.4 Web-Platform项目结构的约定
								</a></li>
							</ul></li>
						<li><a href="#cryptoDemo">2. 控制器(controller)</a>
							<ul class="nav">
								<li><a href="#addJar">2.1 Controller的定义</a></li>
								<li><a href="#modifyWeb">2.2 路径的映射 </a>
									<ul class="nav">
										<li><a href="#addJar">2.2.1 URL请求对应到controller</a></li>
										<li><a href="#modifyWeb">2.2.3 多路径映射</a></li>
										<li><a href="#addCryptoConfig">2.2.4
												post、get、put、delete请求</a></li>
										<li><a href="#modifyWeb">2.2.5 用正则表达式表达的URL </a></li>
										<li><a href="#addCryptoConfig">2.2.6 占位符"$"在url中的使用 </a></li>
										<li><a href="#addCryptoConfig">2.2.7 模块规约 </a></li>
									</ul></li>
								<li><a href="#addCryptoConfig">2.3 参数的绑定</a>
									<ul class="nav">
										<li><a href="#addJar">2.3.1 基本类型的参数绑定</a></li>
										<li><a href="#modifyWeb">2.3.2 Map和集合类型的参数绑定</a></li>
										<li><a href="#addCryptoConfig">2.3.3 枚举类型的参数绑定</a></li>
										<li><a href="#modifyWeb">2.3.4 java bean类型的参数绑定 </a></li>
									</ul></li>
								<li><a href="#modifyWeb">2.4 控制器的返回路径 </a>
									<ul class="nav">
										<li><a href="#addJar">2.4.1 如何定位返回页面</a></li>
										<li><a href="#modifyWeb">2.4.2 转发</a></li>
										<li><a href="#addCryptoConfig">2.4.3 重定向</a></li>
										<li><a href="#modifyWeb">2.4.4 无参数类型的返回值方式 </a></li>
									</ul></li>

								<li><a href="#addCryptoConfig">2.5 Invocation</a>
									<ul class="nav">
										<li><a href="#addJar">2.5.1 获取http内置对象</a></li>
										<li><a href="#modifyWeb">2.5.2 绑定数据</a></li>
									</ul></li>
								<li><a href="#modifyWeb">2.6 将数据返回视图 </a>
									<ul class="nav">
										<li><a href="#addJar">2.6.1 Ajax请求</a></li>
										<li><a href="#modifyWeb">2.6.2 非Ajax请求</a></li>
										<li><a href="#addCryptoConfig">2.4.3 重定向</a></li>
										<li><a href="#modifyWeb">2.4.4 无参数类型的返回值方式 </a></li>
									</ul></li>
							</ul></li>
						<li><a href="#addCryptoConfig">3. 视图(view)</a>
							<ul class="nav">
								<li><a href="#addJar">3.1 Jsp</a>
									<ul class="nav">
										<li><a href="#addJar">3.1.1 Form</a></li>
										<li><a href="#modifyWeb">3.1.2 标签</a></li>
									</ul></li>
								<li><a href="#modifyWeb">3.2 Velocity</a></li>
							</ul></li>

						<li><a href="#modifyWeb">4. url管理 </a></li>


						<li><a href="#addCryptoConfig">5. 拦截器(Interceptor)</a>
							<ul class="nav">
								<li><a href="#addJar">5.1 拦截器的位置</a></li>
								<li><a href="#modifyWeb">5.2 拦截器的拦截条件</a></li>
								<li><a href="#modifyWeb">##5.3 拦截器的实现</a>
									<ul class="nav">
										<li><a href="#addJar">5.3.1 Intercepted注解</a></li>
										<li><a href="#modifyWeb">5.3.2 拦截器的顺序</a></li>
									</ul></li>
							</ul></li>

						<li><a href="#modifyWeb">6. 数据校验 </a>
							<ul class="nav">
								<li><a href="#addJar">6.1 Web-Platform的数据校验</a></li>
								<li><a href="#modifyWeb">2.6.2 非Ajax请求</a></li>
								<li><a href="#addCryptoConfig">6.2 @Validation中的规则</a></li>
								<li><a href="#modifyWeb">6.3 参数的校验 </a></li>
								<li><a href="#addJar">6.4 javabean的校验</a></li>
								<li><a href="#modifyWeb">6.5 校验的错误信息</a></li>
								<li><a href="#addCryptoConfig">6.6 自定义的数据校验</a></li>
							</ul></li>


						<li><a href="#modifyWeb">7.文件上传 </a>
							<ul class="nav">
								<li><a href="#addJar">7.1 单个文件的上传</a></li>
								<li><a href="#modifyWeb">7.2 多个文件的上传</a></li>
								<li><a href="#addCryptoConfig">7.3 混合文件上传</a></li>
								<li><a href="#modifyWeb">7.4 上传所有文件 </a></li>
							</ul></li>


						<li><a href="#modifyWeb">8. 异常处理 </a>
							<ul class="nav">
								<li><a href="#addJar">8.1 最简单的</a></li>
								<li><a href="#modifyWeb">8.2 放在哪里才能生效</a></li>
								<li><a href="#addCryptoConfig">8.3 区分异常类型的</a></li>
								<li><a href="#modifyWeb">8.4 更好的区分不同的异常类型 </a></li>
								<li><a href="#addJar">8.5 将异常让渡给上级模块的错误处理器处理</a></li>
								<li><a href="#modifyWeb">8.6 异常处理的Adapter </a></li>
							</ul></li>


						<li><a href="#modifyWeb">9. Portal </a></li>

						<li><a href="#addCryptoConfig">10 Pipe </a></li>
						<li><a href="#addCryptoConfig">11 国际化 </a></li>
					</ul>
				</div>
			</div>

			<div class="col-md-9" role="main">
            <h1 id="introduction">1. Web Framework</h1>
...
<pre><code>Web-Platform基于Spring MVC3，对于SpringMVC的优势我们予以保留，并在此基础上做了优化以及增加了很多的最佳实践。
            ...
            <h2>1.3 如何构建一个Restful风格的web项目</h2>

            <p>您可以参考我们的指南文档，<a href="#">快速构建Restful风格的Web工程</a></p>

            <h2>1.4 Web-Platform项目结构的约定</h2>
