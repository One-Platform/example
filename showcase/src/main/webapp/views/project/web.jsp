...
<p>One MVC基于Spring MVC3,对于SpringMVC的优势我们予以保留,并在此基础上做了优化以及增加了很多的最佳实践.</p>
...
<p>one-web包含了许多模块,这里我们列出了如何以<code>controller</code>为核心构建一个web程序</p>

<p>当您引好<code>one-web</code>依赖后,在WebConten/WEB-INF下创建web.xml,并配置MvcFilter:</p>

<p><code>web.xml</code></p>

<div class="highlight">
    <button class="copy-button snippet" id="copy-button-0" data-clipboard-target="code-block-0"></button>
    <pre id="code-block-0"><code>
        <span class="nc">&lt;?xml <span class="nf">version</span>="1.0" <span class="nf">encoding</span>="UTF-8"?&gt;
        &lt;web-app <span class="nf">xmlns:xsi</span>="http://www.w3.org/2001/XMLSchema-instance"
                 <span class="nf">xmlns</span>="http://java.sun.com/xml/ns/javaee"
                 <span class="nf">xmlns:web</span>="http://java.sun.com/xml/ns/javaee/web-app_2_5.xsd"
                 <span class="nf">xsi:schemaLocation</span>="http://java.sun.com/xml/ns/javaee
                 http://java.sun.com/xml/ns/javaee/web-app_2_5.xsd"
                 id="WebApp_ID" version="2.5"&gt;
        &lt;display-name&gt;<span class="kd">Hello One</span>&lt;/display-name&gt;
        &lt;filter&gt;
            &lt;filter-name&gt;<span class="kd">MvcFilter</span>&lt;/filter-name&gt;
            &lt;filter-class&gt;<span class="kd">com.sinosoft.one.mvc.MvcFilter</span>&lt;/filter-class&gt;
        &lt;/filter&gt;

        &lt;filter-mapping&gt;
            &lt;filter-name&gt;<span class="kd">MvcFilter</span>&lt;/filter-name&gt;
            &lt;url-pattern&gt;<span class="kd">/*</span>&lt;/url-pattern&gt;
            &lt;dispatcher&gt;<span class="kd">REQUEST</span>&lt;/dispatcher&gt;
            &lt;dispatcher&gt;<span class="kd">FORWARD</span>&lt;/dispatcher&gt;
            &lt;dispatcher&gt;<span class="kd">INCLUDE</span>&lt;/dispatcher&gt;
        &lt;/filter-mapping&gt;
...
<div class="highlight">
    <button class="copy-button snippet" id="copy-button-1" data-clipboard-target="code-block-1"></button><pre
        id="code-block-1"><code class="java language-java" data-lang="java">
    <span class="kn">package</span> <span class="n">com.sinosoft.controllers.hello</span><span class="o">;</span>

    <span class="kn">import</span> <span
            class="nn">com.sinosoft.one.mvc.web.Invocation</span><span class="o">;</span>
    <span class="kn">import</span> <span class="nn">com.sinosoft.one.mvc.web.annotation.Path</span><span
            class="o">;</span>
    <span class="kn">import</span> <span class="nn">com.sinosoft.one.mvc.web.annotation.rest.Get</span><span
        class="o">;</span>
...
<div class="highlight">
    <button class="copy-button snippet" id="copy-button-2" data-clipboard-target="code-block-2"></button><pre
        id="code-block-2"><code class="java language-java" data-lang="java">
    &lt;!DOCTYPE html PUBLIC <span class="nc">"-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"</span>&gt;
    &lt;html&gt;
    &lt;head&gt;
    &lt;meta http-equiv="<span class="nc">Content-Type</span>" content="<span class="nc">text/html</span>; charset=<span class="nc">UTF-8</span>"&gt;
