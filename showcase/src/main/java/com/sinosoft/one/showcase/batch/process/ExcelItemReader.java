...
public class ExcelItemReader extends FlatFileItemReader<Object> {
	...
	public void open(ExecutionContext executioncontext)
		...
		try {
			...
			if (header != null) {
				for (int i = header.getFirstCellNum(); i < header
						.getLastCellNum(); i++) {
			...
			totalRows = physicalNumberOfRows < lastRowNum ? physicalNumberOfRows
					: lastRowNum;
